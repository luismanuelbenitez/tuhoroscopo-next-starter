...
import { RefreshCw, AlertTriangle, MessageCircle, Wand2, Wrench, ShieldCheck } from "lucide-react";
...
export function AdminHub() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-8 space-y-8">
      ...
      {/* === Estado del sistema === */}
      <section>
        <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Estado del sistema</p>
          ...
          {cargandoConfig ? (
            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-3">
                {modoMantenimiento.valor === "true" ? (
                  <Wrench size={18} className="text-red-400 shrink-0" />
                ) : (
                  <ShieldCheck size={18} className="text-gray-500 shrink-0" />
                )}
                <div>
                  <p className={`text-sm font-semibold ${modoMantenimiento.valor === "true" ? "text-red-300" : "text-gray-200"}`}>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    {modoMantenimiento.valor === "true"
                      ...
                      : "Todos los visitantes acceden al sitio con normalidad."}
                  </p>
                </div>
              </div>
