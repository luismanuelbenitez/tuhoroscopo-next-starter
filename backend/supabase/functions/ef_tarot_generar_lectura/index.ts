...
async function generarLectura(ordenId: string): Promise<void> {
  ...
  const productoConfig: ProductoConfig = productoConfigRow
    ? {
        ...
        max_words_resumen: productoConfigRow.max_words_resumen ?? 240,
        max_words_mensaje_final: productoConfigRow.max_words_mensaje_final ?? 100,
    ...
    : {
        ...
        max_words_resumen: 240,
        max_words_mensaje_final: 100,
